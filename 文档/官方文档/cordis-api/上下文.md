<!-- 英文源文件由 scripts/gen-cordis-catalog.ts 生成；本中文文件是通过双语配对维护的经评审对侧。
     更新时先运行 `pnpm run gen-cordis-catalog` 更新英文，再更新本文件并运行 `pnpm run verify-translation-pairing --write 文档/cordis-api/上下文.md` 重新记录配对。 -->

# 上下文

上下文是 Cordis 的核心对象：所有服务、事件和生命周期 API 都通过 `ctx` 访问。事件方法见[事件](事件.md)，副作用与当前 fiber 见 [Fiber](纤程.md)，插件加载见[注册表](注册表.md)。

Cordis 插件的根依赖容器和子依赖容器。

上下文是一个代理：普通属性读取通过服务解析器进行，而 `extend()`、`isolate()` 和 `intercept()` 会创建有作用域的子上下文，且不修改其父上下文。

[源码](../../依赖快照/cordis/src/context.ts#L42)
...
[源码](../../依赖快照/cordis/src/context.ts#L99)
...
[源码](../../依赖快照/cordis/src/context.ts#L121)
...
[源码](../../依赖快照/cordis/src/context.ts#L139)
...
[源码](../../依赖快照/cordis/src/context.ts#L22)
...
[源码](../../依赖快照/cordis/src/context.ts#L24)
...
[源码](../../依赖快照/cordis/src/context.ts#L26)
...
[源码](../../依赖快照/cordis/src/context.ts#L28)
...
[源码](../../依赖快照/cordis/src/context.ts#L30)
...
[源码](../../依赖快照/cordis/src/context.ts#L32)
...
[源码](../../依赖快照/cordis/src/context.ts#L44)
...
[源码](../../依赖快照/cordis/src/context.ts#L46)
...
[源码](../../依赖快照/cordis/src/context.ts#L48)
...
[源码](../../依赖快照/cordis/src/context.ts#L50)
...
[源码](../../依赖快照/cordis/src/context.ts#L61)
...
[源码](../../依赖快照/cordis/src/reflect.ts#L17)
...
[源码](../../依赖快照/cordis/src/reflect.ts#L29)
...
[源码](../../依赖快照/cordis/src/reflect.ts#L44)
...
[源码](../../依赖快照/cordis/src/reflect.ts#L56)
...
[源码](../../依赖快照/cordis/src/reflect.ts#L67)
