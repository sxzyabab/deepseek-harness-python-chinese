...
[Conversation Node 组装决策](../../.agents/notes/已实现/架构/2026-08-09-client-conversation-node-assembly.md)记录完整的引擎模型和设计理由；本文只说明实现路径。
...
流式与中断处理可参考 [`源码/客户端/ui-对话/src/client/conversation-nodes/assistant.ts`](../../源码/客户端/ui-对话/src/client/conversation-nodes/assistant.ts)，前序查询可参考 [`inbox.ts`](../../源码/客户端/ui-对话/src/client/conversation-nodes/inbox.ts) 与 [`message.ts`](../../源码/客户端/ui-对话/src/client/conversation-nodes/message.ts)，只发布 Turn data 而不创建自有 Node 的例子见 [`源码/客户端/ui-产出`](../../源码/客户端/ui-产出)。
