...
[dsh-tools](../../源码/内核/工具) 的工具流水线。[内核.md](内核.md) 介绍了核心包共用、用于编写流水线的类型 `ToolDefinition`；面向模型的 [`ToolSchema`](流式输出.md#the-model-request-and-result) 协议类型与模型请求一起声明。本页记录 `ToolDefinition` 的每个字段、用于构建它的类型化 schema DSL、带守卫的执行类型和 UI 展示类型。

源码：[`源码/内核/工具/src/index.ts`](../../源码/内核/工具/src/index.ts) · [`源码/内核/工具/src/schema.ts`](../../源码/内核/工具/src/schema.ts) · [`源码/内核/工具/src/presentation.ts`](../../源码/内核/工具/src/presentation.ts)
...
interface ToolDefinition extends ToolSchema {
   ...
   * [parallel-tool-call Agent Note](../../.agents/notes/已实现/功能/2026-07-10-并行工具调用执行.md)
...
源码：[`源码/内核/工具/src/schema.ts`](../../源码/内核/工具/src/schema.ts)
...
`ToolCallKind`（`'read' | 'edit' | 'delete' | 'move' | 'search' | 'execute' | 'fetch' | 'other'`）用于为通用卡片选择图标。`FileLocation`（`{ path, line? }`）、`FileDiff`（`{ path, oldText, newText }`）与 `ReadFileLine`（`{ number, text }`，读取窗口中一行带 1-based 行号的内容）是共享的文件卡片词汇。该设计由[渲染意图联合类型 Agent Note](../../.agents/notes/已实现/架构/2026-07-02-工具渲染意图联合.md)固定；host/client 运行时将这套中性词汇投影为各自的视图。

完整的展示字段文档见 [`源码/内核/工具/src/presentation.ts`](../../源码/内核/工具/src/presentation.ts)。`bash` schema 与执行器见 [Bash执行器.md](Bash执行器.md)；通用后台控制见 [后台任务运行时.md](后台任务运行时.md)。
...
Source: [`源码/内核/工具/src/index.ts:787`](../../源码/内核/工具/src/index.ts)
...
Source: [`源码/内核/工具/src/index.ts:207`](../../源码/内核/工具/src/index.ts)
...
Types: [ContentBlock](流式输出.md) · [Scoped](作用域注册.md)

Source: [`源码/内核/工具/src/index.ts:189`](../../源码/内核/工具/src/index.ts)
...
Source: [`源码/内核/工具/src/index.ts:163`](../../源码/内核/工具/src/index.ts)
...
Source: [`源码/内核/工具/src/index.ts:175`](../../源码/内核/工具/src/index.ts)
...
Source: [`源码/内核/工具/src/index.ts:152`](../../源码/内核/工具/src/index.ts)
...
Source: [`源码/内核/工具/src/index.ts:197`](../../源码/内核/工具/src/index.ts)
