...
可选的文件系统能力由四个部分组成：[dsh-fs](../../源码/文件系统/文件系统) 拥有 `ctx.fs` 以及带可选守卫的原子文本操作；[dsh-fs-local](../../源码/文件系统/本地文件系统) 实现本地磁盘后端；[dsh-fs-observation-policy](../../源码/文件系统/文件系统观察策略) 记录观测到的存在或缺失状态，并通过事件（而非服务）添加新鲜度规则；[dsh-tool-fs](../../源码/文件系统/文件系统工具) 直接执行面向模型的 read/write/edit 调用并渲染窗口。它位于 agent loop（智能体循环）主干之外；替换后端不会改变策略或工具 schema。
...
提供方源码：[`源码/文件系统/文件系统/src/types.ts`](../../源码/文件系统/文件系统/src/types.ts) 与 [`源码/文件系统/文件系统/src/index.ts`](../../源码/文件系统/文件系统/src/index.ts)。策略源码：[`源码/文件系统/文件系统观察策略/src/types.ts`](../../源码/文件系统/文件系统观察策略/src/types.ts)。读取渲染源码：[`源码/文件系统/文件系统工具/src/read-render.ts`](../../源码/文件系统/文件系统工具/src/read-render.ts)。
...
Types: [SandboxExecutionPolicy](进程沙箱.md)

Source: [`源码/文件系统/文件系统/src/index.ts:86`](../../源码/文件系统/文件系统/src/index.ts)
...
Source: [`源码/文件系统/文件系统/src/index.ts:66`](../../源码/文件系统/文件系统/src/index.ts)
...
Source: [`源码/文件系统/文件系统/src/index.ts:76`](../../源码/文件系统/文件系统/src/index.ts)
...
Source: [`源码/文件系统/文件系统/src/index.ts:58`](../../源码/文件系统/文件系统/src/index.ts)
