...
[`dsh-commands`](../../源码/交互/命令) 提供的用户命令注册表服务。交互式适配器用它发现插件拥有的命令，并针对确切的 agent（智能体）直接执行这些命令，而不创建模型消息。[命令 Agent Note](../../.agents/notes/已实现/功能/2026-07-19-插件命令注册.md) 负责分发与生命周期的决策依据；[包 README](../../源码/交互/命令/README.zh.md) 负责组合方式与限制。

来源：[`源码/交互/命令/src/index.ts`](../../源码/交互/命令/src/index.ts)
...
Source: [`源码/交互/命令/src/index.ts:225`](../../源码/交互/命令/src/index.ts)
...
Source: [`源码/交互/命令/src/types.ts:72`](../../源码/交互/命令/src/types.ts)
