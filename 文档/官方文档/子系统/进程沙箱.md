...
[dsh-sandbox](../../源码/沙盒/沙盒) 的进程沙箱 seam 将与宿主共享文件系统和内核的子进程 argv 包装在文件效果策略中，而不将消费方耦合到特定平台运行器。[dsh-sandbox-local](../../源码/沙盒/本地沙盒) 提供 Linux bwrap/Landlock、macOS Seatbelt 与 Windows ACL 受限令牌后端；[dsh-bash-sandbox](../../源码/命令/沙盒bash) 和 [dsh-pwsh-sandbox](../../源码/命令/沙盒powershell) 是其消费方。容器、microVM 和远程执行是完整能力 seam 的同级实现，而非 `ctx.sandbox` 的提供方。

源码：[`源码/沙盒/沙盒/src/index.ts`](../../源码/沙盒/沙盒/src/index.ts)
...
[本地提供方](../../源码/沙盒/本地沙盒/README.zh.md)拥有运维配置，并将其 runner 方言映射到这些规则。[沙箱化 bash 消费方](../../源码/命令/沙盒bash/README.zh.md)拥有 spawn 与结果归因。
...
提供方选择、探测、缓存和后端特定的强制执行报告归[本地提供方](../../源码/沙盒/本地沙盒/README.zh.md)所有。
...
Source: [`源码/沙盒/沙盒/src/index.ts:158`](../../源码/沙盒/沙盒/src/index.ts)
...
Source: [`源码/沙盒/沙盒策略/src/index.ts:91`](../../源码/沙盒/沙盒策略/src/index.ts)
