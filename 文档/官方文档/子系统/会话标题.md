...
[`@deepseek-ai/dsh-session-title`](../../源码/会话/会话标题) 所拥有的持久、后写覆盖的标题状态与可选异步提供方词汇。共享 LLM（大语言模型）辅助组件负责精确的辅助请求记录。各包 README 负责时序、回退、失败与 fork 行为；生成的[持久化日志事件目录](../会话持久化.md)负责完整的事件声明。

源码：[`源码/会话/会话标题/src/index.ts`](../../源码/会话/会话标题/src/index.ts)、[`源码/会话/会话标题-llm/src/index.ts`](../../源码/会话/会话标题-llm/src/index.ts)
...
Source: [`源码/会话/会话标题/src/index.ts:261`](../../源码/会话/会话标题/src/index.ts)
