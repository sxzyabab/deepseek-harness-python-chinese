...
[system-prompt 包](../../源码/内核/系统提示词)负责管理提示词贡献者与一次组装调用之间交换的数据。该包的 [README](../../源码/内核/系统提示词/README.zh.md) 记录注册、排序、作用域与渲染行为；本页记录各插件实现或传递的确切跨包类型。

源码：[`源码/内核/系统提示词/src/index.ts`](../../源码/内核/系统提示词/src/index.ts)。
...
Source: [`源码/内核/系统提示词/src/index.ts:338`](../../源码/内核/系统提示词/src/index.ts)
...
Source: [`源码/内核/系统提示词/src/index.ts:31`](../../源码/内核/系统提示词/src/index.ts)
...
Source: [`源码/内核/系统提示词/src/index.ts:37`](../../源码/内核/系统提示词/src/index.ts)
