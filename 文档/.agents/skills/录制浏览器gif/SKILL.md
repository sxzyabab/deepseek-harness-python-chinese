...
The [evidence-chain decision](../../notes/已实现/流程/2026-08-08-浏览器gif证据链.md) owns why one storyboard comes from one isolated run and why publication revalidates both the artifact and the demonstrated pull-request head.
