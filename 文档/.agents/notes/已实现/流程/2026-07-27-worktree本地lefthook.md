...
[English](2026-07-27-worktree本地lefthook.md) | 中文
...
安装或移除任一 worktree 不再改变其他 worktree 的生效钩子、二进制文件路径或生成的钩子字节。并发安装会串行执行，重复安装保持幂等；[快速本地 Git 钩子](2026-07-22-快速本地git钩子.md)所规定的任务与延迟边界保持不变。
