...
[English](2026-07-29-oxlint检查器.md) | 中文
...
**使用单独的格式化器。** 迁移保留了窄范围的 ESLint 流程，因为当时认为兼容层无法执行修复。锁定版本的工具链证明能够执行相同修复后，[仅使用 Oxlint 的修复工作流](2026-08-09-仅oxlint的格式工作流.md)以一次有界重试取代了该部分决策。
