...
- Read [docs/AGENTS.md](../../../docs/AGENTS.md) and use [dsh-doc-standards](../文档标准.md) when deciding where content belongs or changing product documentation prose.
...
Use [dsh-pre-push-checks](../推送前检查.md) before pushing. Report the canonical files changed, manifest entries added or removed, public routes affected, and the exact checks run.
