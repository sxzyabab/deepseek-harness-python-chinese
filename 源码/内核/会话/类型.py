...
def 待办条目(内容,状态):
    ...
    return {'content':内容,'status':状态}

class 纪元请求头(TypedDict):
...
会话事件信封字段=('type','seq','time','data','ignorable','sourceEventSeqs','surfaceOp')
