...
def _可选字符串(参数,键):#可选字符串
    ...
    if not isinstance(值,str):#类型
        raise ValueError(f'{键} 必须是字符串')#抛错
    return {键:值}#字段
