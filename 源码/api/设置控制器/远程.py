...
远程贡献表=远程贡献(包名,[#贡献
    调用描述符(设置前+'describe',设置服务,设置命名空间,'describe',
        [],严格编解码('SettingsDescribeValue'),{'file':'src/index.ts','line':98,'column':3}),
    调用描述符(设置前+'update',设置服务,设置命名空间,'update',
        ...
        严格编解码('SettingsNamespaceView'),{'file':'src/index.ts','line':116,'column':3}),
    调用描述符(设置前+'replace',设置服务,设置命名空间,'replace',
        ...
        严格编解码('SettingsNamespaceView'),{'file':'src/index.ts','line':133,'column':3}),
    调用描述符(设置前+'mutate',设置服务,设置命名空间,'mutate',
        ...
        严格编解码('SettingsNamespaceView'),{'file':'src/index.ts','line':152,'column':3}),
    调用描述符(设置前+'openSettingsDocument',设置服务,设置命名空间,'openSettingsDocument',
        [],严格编解码('SettingsDocumentOpenValue'),{'file':'src/index.ts','line':167,'column':3},
        取消={'parameter':'signal'}),
