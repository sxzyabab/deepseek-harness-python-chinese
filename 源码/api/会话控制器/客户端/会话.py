...
class 会话:
    ...
    def prompt(自身,内容,模式,信号=None,请求标识=None):
        ...
        if 自身._地址 is None:#普通
            ...
            结果={'ok':False,'error':远程错误('subagent/attachment-invalid','subagent continuation does not accept files',{'reason':'SUBAGENT_FILE_UNSUPPORTED'})}
        else:#子智能体
