...
from .锚定位置 import 锚定位置#锚点放置
from .代码高亮语法 import 代码高亮扩展名,路径语言,使用代码高亮器#语法高亮
from .表单模型 import 设置表单模型,设置数字字段,设置文本字段#设置暂存表单
...
__all__=[#仅中文公开名
    ...
    '锚定位置','代码高亮扩展名','路径语言','使用代码高亮器',
    '设置表单模型','设置数字字段','设置文本字段',
]
