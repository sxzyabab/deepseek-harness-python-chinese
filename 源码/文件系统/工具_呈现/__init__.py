...
对齐上游 `@deepseek-ai/dsh-tool-present`。公开业务面仅中文名；Cordis 协议槽（name/inject/Config/apply/default）保留英文别名供加载器识别，不入 `__all__`。包名单 `tool-present`、工具名 `present`、事件 `deliverables/presented` 与配置键 `maxFiles` 保持英文。
"""
