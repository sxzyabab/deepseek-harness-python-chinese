...
__all__=(#仅中文公开名；Cordis 英文槽不入表
    ...
    '工作流运行身份','工作流智能体信息','工作流智能体结局','工作流智能体结束信息','工作流结果信息',
    '工作流启动请求','工作流运行',
)#公开面结束
...
class 工作流错误(装备错误):#工作流缝的带类型错误
    ...
    def __init__(自身,消息,码,选项=None):#构造工作流错误
        ...
        自身.name='WorkflowError'#固定错误名，对齐 Error.name 习惯
        致命=True#默认致命
...
class 工作流引擎(服务):#工作流引擎服务定义
    ...
    def __init__(自身,上下文):#用 Cordis 上下文构造引擎
        """向宿主注册名为 workflowEngine 的服务。"""
        服务.__init__(自身,上下文,'workflowEngine')#向宿主注册名为 workflowEngine 的服务
